...
if (isset($_POST['admin_register'])) {
    ...
    $check_query = "SELECT * FROM `admin` WHERE admin_name='$admin_name'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // Insert query
        $insert_query = "INSERT INTO `admin` (admin_name, admin_password) VALUES ('$admin_name', '$hash_password')";
        ...
        if ($sql_execute) {
            ...
            echo "<script>alert('Veri Yükleme Başarısız')</script>";
            echo "<script>window.open('admin_registration.php','_self')</script>";
        }
    }
}
            ...
            <div class="col-lg-6 col-xl-5 align-items-center form-container">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" id="admin_password" name="admin_password" placeholder="Lütfen Şifre Giriniz" required="required" class="form-control">
                    </div>
