...
if (isset($_POST['admin_login'])) {
    ...
    if ($result) {
        if (mysqli_num_rows($result) == 1) {
            ...
            echo "<script>alert('Admin Bulunamadı')</script>";
            echo "<script>window.open('admin_login.php','_self')</script>";
        }
    } else {
            ...
            <div class="col-lg-6 col-md-8 mx-auto form-container">
                ...
                <form action="" method="post">
                    ...
                    <div class="text-center">
                        ...
                        <p class="small fw-bold mt-2 pt-1 mb-0">Hesabın yok mu ? <a href="admin_registration.php" class="text-danger">Kayıt Ol</a></p>
                    </div>
                </form>
            </div>
