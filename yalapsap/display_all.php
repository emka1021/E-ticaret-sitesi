            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class='nav-item'><a class='nav-link active' aria-currents='page' href='index.php'>Home</a>
                        </li>
                        ...
                        <li class='nav-item'><a class='nav-link' href='cart.php'><i
                                    class='fa-solid fa-cart-shopping'></i><sup><?php $cartFunctions->cart_item();
                                    ?></sup></a></li>
                        <li class='nav-item'><a class='nav-link d-inline-flex' href='#'>Toplam
                                Ücret:</a><?php $cartFunctions->total_cart_price() ?>/-</li>
                    </ul>
