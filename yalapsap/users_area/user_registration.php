...
if (isset($_POST['user_register'])) {
    ...
    $user_ip = $cartFunctions -> getIPAddress();
    ...
    if ($rows_count > 0) {
        ...
        $insert_query = "INSERT INTO `user_table` (user_name, user_email, user_password, user_ip, user_adress, user_mobile)
        VALUES ('$user_username', '$user_email', '$hash_password', '$user_ip', '$user_adress', '$user_contact')";
